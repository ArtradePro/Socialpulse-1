...
# GATE SP-8C-7A: SYNCHRONIZATION AND EXECUTION WRAPPER (REVISION R24)
...
echo "========================================================================"
echo ">>> HIGIENE (PTY) LTD — GATE SP-8C-7A WRAPPER (REVISION R24)"
...
# Hardcoded trust anchor for sp8c7a_preflight.sh (Revision R24)
EXPECTED_SCRIPT_SHA256="606a9f09ac96c4e3f8fb6e80d57fc42c40824bc78a102f9724337f54604fc9c1"
EXPECTED_SCRIPT_BYTES=66281
EXPECTED_SCRIPT_LINES=1566

# Hardcoded trust anchor for sp8c7a_preflight.sh.sha256 (Revision R24)
EXPECTED_SIDECAR_SHA256="a1c683ab492f208f1d8821ebb4281c2b2793170265af0877085020c1402696aa"
EXPECTED_SIDECAR_BYTES=86
EXPECTED_SIDECAR_LINES=1

# Hardcoded trust anchor for sp8c7a_preflight_runbook.md (Revision R24)
EXPECTED_RUNBOOK_SHA256="fcd158e803005ced2352f43724adf04ee8c47df2a96365dbacddfeca377182bd"
EXPECTED_RUNBOOK_BYTES=16271
EXPECTED_RUNBOOK_LINES=148

# Hardcoded trust anchor for sp8c7a_manifest.json (Revision R24)
EXPECTED_MANIFEST_SHA256="729d41ef4101764d68cab1ce386af01fdc83cec5e56765dbc250a71ba19e8efe"
EXPECTED_MANIFEST_BYTES=6221
EXPECTED_MANIFEST_LINES=128
...
echo ""
echo "========================================================================"
echo ">>> [2/6] Staging Gate SP-8C-7A Revision R24 Approved Artifacts"
echo "========================================================================"
...
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh" 66281 "606a9f09ac96c4e3f8fb6e80d57fc42c40824bc78a102f9724337f54604fc9c1"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh.sha256" 86 "a1c683ab492f208f1d8821ebb4281c2b2793170265af0877085020c1402696aa"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight_runbook.md" 16271 "fcd158e803005ced2352f43724adf04ee8c47df2a96365dbacddfeca377182bd"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_manifest.json" 6221 "729d41ef4101764d68cab1ce386af01fdc83cec5e56765dbc250a71ba19e8efe"
...
assert rev == "R24", f"revision expected R24, got {rev}"
...
expected_workload_members = {
    "sp8c7a_preflight.sh": {
        "bytes": 66281,
        "lines": 1566,
        "sha256": "606a9f09ac96c4e3f8fb6e80d57fc42c40824bc78a102f9724337f54604fc9c1",
        "role": "unified_self_contained_strictly_read_only_host_preflight_script"
    },
    "sp8c7a_preflight.sh.sha256": {
        "bytes": 86,
        "lines": 1,
        "sha256": "a1c683ab492f208f1d8821ebb4281c2b2793170265af0877085020c1402696aa",
        "role": "corroborating_script_checksum_sidecar"
    },
    "sp8c7a_preflight_runbook.md": {
        "bytes": 16271,
        "lines": 148,
        "sha256": "fcd158e803005ced2352f43724adf04ee8c47df2a96365dbacddfeca377182bd",
        "role": "operational_preflight_runbook_and_invariants_revision_r24"
    }
}
...
echo "Staged manifest verified: schema 1.0, gate SP-8C-7A, revision R24, exactly 3 payload members with exact field values."
...
check_and_install_artifact "sp8c7a_preflight.sh" 66281 "606a9f09ac96c4e3f8fb6e80d57fc42c40824bc78a102f9724337f54604fc9c1" "700"
check_and_install_artifact "sp8c7a_preflight.sh.sha256" 86 "a1c683ab492f208f1d8821ebb4281c2b2793170265af0877085020c1402696aa" "600"
check_and_install_artifact "sp8c7a_preflight_runbook.md" 16271 "fcd158e803005ced2352f43724adf04ee8c47df2a96365dbacddfeca377182bd" "600"
check_and_install_artifact "sp8c7a_manifest.json" 6221 "729d41ef4101764d68cab1ce386af01fdc83cec5e56765dbc250a71ba19e8efe" "600"
...
commit_and_cleanup_publication() {
    ...
    reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh" 66281 "606a9f09ac96c4e3f8fb6e80d57fc42c40824bc78a102f9724337f54604fc9c1" "1001:1001" "700"
    reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh.sha256" 86 "a1c683ab492f208f1d8821ebb4281c2b2793170265af0877085020c1402696aa" "1001:1001" "600"
    reverify_destination_file "${DEST_DIR}/sp8c7a_preflight_runbook.md" 16271 "fcd158e803005ced2352f43724adf04ee8c47df2a96365dbacddfeca377182bd" "1001:1001" "600"
    reverify_destination_file "${DEST_DIR}/sp8c7a_manifest.json" 6221 "729d41ef4101764d68cab1ce386af01fdc83cec5e56765dbc250a71ba19e8efe" "1001:1001" "600"
...
set +e
EXPECTED_SP8C7A_SHA256="606a9f09ac96c4e3f8fb6e80d57fc42c40824bc78a102f9724337f54604fc9c1" \
EXPECTED_SP8C7A_BYTES="66281" \
