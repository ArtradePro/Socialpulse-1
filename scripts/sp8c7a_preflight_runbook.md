# Phase SP-8C-7A: Strictly Read-Only Host Preflight Runbook (Revision R5)
...
**Revision:** `R5` (Unified Standalone Script Architecture)  
...
Gate SP-8C-7A Revision R5 executes via one single self-contained unified script: `sp8c7a_preflight.sh`.
* **Script SHA-256:** `d704fadd700f5ba1eaa9321c39c7e269aed6a7cebdb3fa890287a0e9c3fa8595`
* **Script Size:** `49060 bytes` (1187 lines)
* **Corroborating Sidecar SHA-256:** `13c16183a74a84f6f9d67e8b3eb2136cc22e7f681be77b84a80594d681ab1541` (101 bytes, `d704fadd700f5ba1eaa9321c39c7e269aed6a7cebdb3fa890287a0e9c3fa8595  sp8c7a_preflight.sh`)
* **Mandatory Invocation Invariant:**
  The caller must externally provide the exact trust anchor environment variables:
  ```bash
  export EXPECTED_SP8C7A_SHA256="d704fadd700f5ba1eaa9321c39c7e269aed6a7cebdb3fa890287a0e9c3fa8595"
  export EXPECTED_SP8C7A_BYTES="49060"
  ```
...
* **Enforced Controls:**
  ...
  3. Exact `.Config.Image` equality for all four approved immutable image references (`postgres@sha256:fe0737...`, `redis@sha256:ff02b5...`, `backend@sha256:73e9d3...`, `frontend@sha256:8fa270...`); RepoDigests treated strictly as supplemental evidence.
  ...
  10. Canonical non-symlink backup directory verified (`/opt/socialpulse/backups`, `0700`, `1001:1001`, $\ge 100\text{ MB}$); filesystem type, mount source, mount target, and mount options captured explicitly; mandatory `getfacl -p` inspection requiring success and strictly rejecting named-user, named-group, mask, or default ACL entries.
