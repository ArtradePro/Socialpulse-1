...
# GATE SP-8C-7A: REVISION R16 HOST SYNCHRONIZATION & PREFLIGHT EXECUTION WRAPPER
...
echo "========================================================================"
echo ">>> HIGIENE (PTY) LTD — GATE SP-8C-7A REVISION R16 HOST WRAPPER"
...
if [ "$(id -u)" -ne 0 ]; then
    echo "CRITICAL ERROR: run_sp8c7a_r16.sh must be executed as root (EUID 0)!" >&2
    exit 1
fi
...
# Hardcoded trust anchor for sp8c7a_preflight.sh (Revision R16)
EXPECTED_SCRIPT_SHA256="d0e35fcdf8e80400ba551d4d810f91b0689948979e69bdda2e2fb79c5434a416"
EXPECTED_SCRIPT_BYTES=57633
EXPECTED_SCRIPT_LINES=1374

# Hardcoded trust anchor for sp8c7a_preflight.sh.sha256 (Revision R16)
EXPECTED_SIDECAR_SHA256="4e75506566b0091d93c3f7ba969edf1441d300fbee9684a1c93ad74e46dbed18"
EXPECTED_SIDECAR_BYTES=86
EXPECTED_SIDECAR_LINES=1

# Hardcoded trust anchor for sp8c7a_preflight_runbook.md (Revision R16)
EXPECTED_RUNBOOK_SHA256="a9d80aa9bcdcb882b39e6f9e9ffbe67234dc4140507a3d2f95f8b32d19ff3983"
EXPECTED_RUNBOOK_BYTES=8995
EXPECTED_RUNBOOK_LINES=90

# Hardcoded trust anchor for sp8c7a_manifest.json (Revision R16)
EXPECTED_MANIFEST_SHA256="bf78919c1b436a7001bf91fe38f5e8dd95bb4a32696be51ba783d278c4e6bd23"
EXPECTED_MANIFEST_BYTES=4545
EXPECTED_MANIFEST_LINES=97
...
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh" 57633 "d0e35fcdf8e80400ba551d4d810f91b0689948979e69bdda2e2fb79c5434a416"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh.sha256" 86 "4e75506566b0091d93c3f7ba969edf1441d300fbee9684a1c93ad74e46dbed18"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight_runbook.md" 8995 "a9d80aa9bcdcb882b39e6f9e9ffbe67234dc4140507a3d2f95f8b32d19ff3983"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_manifest.json" 4545 "bf78919c1b436a7001bf91fe38f5e8dd95bb4a32696be51ba783d278c4e6bd23"
...
assert rev == "R16", f"revision expected R16, got {rev}"
...
expected_workload_members = {
    "sp8c7a_preflight.sh": {
        "bytes": 57633,
        "lines": 1374,
        "sha256": "d0e35fcdf8e80400ba551d4d810f91b0689948979e69bdda2e2fb79c5434a416",
        "role": "unified_self_contained_strictly_read_only_host_preflight_script"
    },
    "sp8c7a_preflight.sh.sha256": {
        "bytes": 86,
        "lines": 1,
        "sha256": "4e75506566b0091d93c3f7ba969edf1441d300fbee9684a1c93ad74e46dbed18",
        "role": "corroborating_script_checksum_sidecar"
    },
    "sp8c7a_preflight_runbook.md": {
        "bytes": 8995,
        "lines": 90,
        "sha256": "a9d80aa9bcdcb882b39e6f9e9ffbe67234dc4140507a3d2f95f8b32d19ff3983",
        "role": "operational_preflight_runbook_and_invariants_revision_r16"
    }
}
...
echo "Staged manifest verified: schema 1.0, gate SP-8C-7A, revision R16, exactly 3 payload members with exact field values."
...
check_and_install_artifact "sp8c7a_preflight.sh" 57633 "d0e35fcdf8e80400ba551d4d810f91b0689948979e69bdda2e2fb79c5434a416" "700"
check_and_install_artifact "sp8c7a_preflight.sh.sha256" 86 "4e75506566b0091d93c3f7ba969edf1441d300fbee9684a1c93ad74e46dbed18" "600"
check_and_install_artifact "sp8c7a_preflight_runbook.md" 8995 "a9d80aa9bcdcb882b39e6f9e9ffbe67234dc4140507a3d2f95f8b32d19ff3983" "600"
check_and_install_artifact "sp8c7a_manifest.json" 4545 "bf78919c1b436a7001bf91fe38f5e8dd95bb4a32696be51ba783d278c4e6bd23" "600"
...
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh" 57633 "d0e35fcdf8e80400ba551d4d810f91b0689948979e69bdda2e2fb79c5434a416" "1001:1001" "700"
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh.sha256" 86 "4e75506566b0091d93c3f7ba969edf1441d300fbee9684a1c93ad74e46dbed18" "1001:1001" "600"
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight_runbook.md" 8995 "a9d80aa9bcdcb882b39e6f9e9ffbe67234dc4140507a3d2f95f8b32d19ff3983" "1001:1001" "600"
reverify_destination_file "${DEST_DIR}/sp8c7a_manifest.json" 4545 "bf78919c1b436a7001bf91fe38f5e8dd95bb4a32696be51ba783d278c4e6bd23" "1001:1001" "600"
...
set +e
EXPECTED_SP8C7A_SHA256="d0e35fcdf8e80400ba551d4d810f91b0689948979e69bdda2e2fb79c5434a416" \
EXPECTED_SP8C7A_BYTES="57633" \
...
if [ "${PREFLIGHT_STATUS}" -eq 0 ]; then
    ...
    echo "Gate SP-8C-7A Revision R16 host synchronization and preflight execution PASSED with PREFLIGHT_COMPLETE_NO_FINDINGS (exit code 0)."
    exit 0
    ...
    echo "Gate SP-8C-7A Revision R16 host synchronization and preflight execution CONCLUDED with PREFLIGHT_COMPLETE_WITH_FINDINGS (exit code 2)."
