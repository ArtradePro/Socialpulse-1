...
# GATE SP-8C-7A REVISION R6: HOST STAGING, VERIFICATION & PREFLIGHT WRAPPER
# Target Host: srv1935605 (2.24.130.251)
# Script Name: run_sp8c7a_r6.sh
...
echo ""
echo "========================================================================"
echo ">>> [2/6] Downloading Approved Gate SP-8C-7A R6 Artifacts into Staging"
echo "========================================================================"
...
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh" 48326 "38f1322c8aceb754231367e46367575d109036f8b9748b7bcfa5564f79fdec47"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh.sha256" 86 "3047cdcf86513cbd89490e70b4af2146824d0ae58705b21904ddedb187e2e81d"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight_runbook.md" 4998 "0a1adab8b16d05d044a98e8c8dece6c7aeb8aff879bd5c87fe6ff6595b71b45a"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_manifest.json" 2740 "153ce56169452c7f409bdc7105e09fd00c247d39f3a2f39e584a6c260395abb4"
...
assert rev == "R6", f"revision expected R6, got {rev}"
...
expected_members = {
    "sp8c7a_preflight.sh": {
        "bytes": 48326,
        "lines": 1166,
        "sha256": "38f1322c8aceb754231367e46367575d109036f8b9748b7bcfa5564f79fdec47",
        "role": "unified_self_contained_strictly_read_only_host_preflight_script"
    },
    "sp8c7a_preflight.sh.sha256": {
        "bytes": 86,
        "lines": 1,
        "sha256": "3047cdcf86513cbd89490e70b4af2146824d0ae58705b21904ddedb187e2e81d",
        "role": "corroborating_script_checksum_sidecar"
    },
    "sp8c7a_preflight_runbook.md": {
        "bytes": 4998,
        "lines": 43,
        "sha256": "0a1adab8b16d05d044a98e8c8dece6c7aeb8aff879bd5c87fe6ff6595b71b45a",
        "role": "operational_preflight_runbook_and_invariants_revision_r6"
    }
}
...
echo "Staged manifest verified: schema 1.0, SP-8C-7A, R6, exactly 3 members with exact field values."
    ...
    if [ -e "${dest_file}" ]; then
        ...
        if [ "${act_bytes}" -eq "${exp_bytes}" ] && \
           ...
           [ "${act_mode}" = "${exp_mode}" ]; then
            echo "Destination ${fname} already exists and matches the approved R6 artifact exactly (preserving without re-installation)."
            return 0
        else
            echo "CRITICAL ERROR: Destination collision at ${dest_file}! Existing file does not match approved R6 artifact." >&2
...
check_and_install_artifact "sp8c7a_preflight.sh" 48326 "38f1322c8aceb754231367e46367575d109036f8b9748b7bcfa5564f79fdec47" "700"
check_and_install_artifact "sp8c7a_preflight.sh.sha256" 86 "3047cdcf86513cbd89490e70b4af2146824d0ae58705b21904ddedb187e2e81d" "600"
check_and_install_artifact "sp8c7a_preflight_runbook.md" 4998 "0a1adab8b16d05d044a98e8c8dece6c7aeb8aff879bd5c87fe6ff6595b71b45a" "600"
check_and_install_artifact "sp8c7a_manifest.json" 2740 "153ce56169452c7f409bdc7105e09fd00c247d39f3a2f39e584a6c260395abb4" "600"
...
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh" 48326 "38f1322c8aceb754231367e46367575d109036f8b9748b7bcfa5564f79fdec47" "1001:1001" "700"
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh.sha256" 86 "3047cdcf86513cbd89490e70b4af2146824d0ae58705b21904ddedb187e2e81d" "1001:1001" "600"
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight_runbook.md" 4998 "0a1adab8b16d05d044a98e8c8dece6c7aeb8aff879bd5c87fe6ff6595b71b45a" "1001:1001" "600"
reverify_destination_file "${DEST_DIR}/sp8c7a_manifest.json" 2740 "153ce56169452c7f409bdc7105e09fd00c247d39f3a2f39e584a6c260395abb4" "1001:1001" "600"
...
set +e
EXPECTED_SP8C7A_SHA256="38f1322c8aceb754231367e46367575d109036f8b9748b7bcfa5564f79fdec47" \
EXPECTED_SP8C7A_BYTES="48326" \
