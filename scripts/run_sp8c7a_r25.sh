...
# GATE SP-8C-7A: SYNCHRONIZATION AND EXECUTION WRAPPER (REVISION R25)
...
echo "========================================================================"
echo ">>> HIGIENE (PTY) LTD — GATE SP-8C-7A WRAPPER (REVISION R25)"
...
# Hardcoded trust anchor for sp8c7a_preflight.sh (Revision R25)
EXPECTED_SCRIPT_SHA256="9ee266b4c2b62da63a08505efd0389ce54253e9b39c6659f316a47b6a564ba98"
EXPECTED_SCRIPT_BYTES=66422
EXPECTED_SCRIPT_LINES=1580

# Hardcoded trust anchor for sp8c7a_preflight.sh.sha256 (Revision R25)
EXPECTED_SIDECAR_SHA256="5c0090543217c89cbac6efd48fe60df18114c20adb128c2427ec21c18a22c252"
EXPECTED_SIDECAR_BYTES=86
EXPECTED_SIDECAR_LINES=1

# Hardcoded trust anchor for sp8c7a_preflight_runbook.md (Revision R25)
EXPECTED_RUNBOOK_SHA256="fcb147c778c7fa569a18274a1414b821345382e8fb734a790bf00cd3b7eb8c49"
EXPECTED_RUNBOOK_BYTES=16706
EXPECTED_RUNBOOK_LINES=149

# Hardcoded trust anchor for sp8c7a_manifest.json (Revision R25)
EXPECTED_MANIFEST_SHA256="2df5cd9971c7bc79d64d39461b756f46c3d42c4f992bb1b1631039574ff810af"
EXPECTED_MANIFEST_BYTES=6295
EXPECTED_MANIFEST_LINES=129
...
echo ""
echo "========================================================================"
echo ">>> [2/6] Staging Gate SP-8C-7A Revision R25 Approved Artifacts"
echo "========================================================================"
...
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh" 66422 "9ee266b4c2b62da63a08505efd0389ce54253e9b39c6659f316a47b6a564ba98"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh.sha256" 86 "5c0090543217c89cbac6efd48fe60df18114c20adb128c2427ec21c18a22c252"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight_runbook.md" 16706 "fcb147c778c7fa569a18274a1414b821345382e8fb734a790bf00cd3b7eb8c49"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_manifest.json" 6295 "2df5cd9971c7bc79d64d39461b756f46c3d42c4f992bb1b1631039574ff810af"
...
assert rev == "R25", f"revision expected R25, got {rev}"
...
expected_workload_members = {
    "sp8c7a_preflight.sh": {
        "bytes": 66422,
        "lines": 1580,
        "sha256": "9ee266b4c2b62da63a08505efd0389ce54253e9b39c6659f316a47b6a564ba98",
        "role": "unified_self_contained_strictly_read_only_host_preflight_script"
    },
    "sp8c7a_preflight.sh.sha256": {
        "bytes": 86,
        "lines": 1,
        "sha256": "5c0090543217c89cbac6efd48fe60df18114c20adb128c2427ec21c18a22c252",
        "role": "corroborating_script_checksum_sidecar"
    },
    "sp8c7a_preflight_runbook.md": {
        "bytes": 16706,
        "lines": 149,
        "sha256": "fcb147c778c7fa569a18274a1414b821345382e8fb734a790bf00cd3b7eb8c49",
        "role": "operational_preflight_runbook_and_invariants_revision_r25"
    }
}
...
echo "Staged manifest verified: schema 1.0, gate SP-8C-7A, revision R25, exactly 3 payload members with exact field values."
...
check_and_install_artifact "sp8c7a_preflight.sh" 66422 "9ee266b4c2b62da63a08505efd0389ce54253e9b39c6659f316a47b6a564ba98" "700"
check_and_install_artifact "sp8c7a_preflight.sh.sha256" 86 "5c0090543217c89cbac6efd48fe60df18114c20adb128c2427ec21c18a22c252" "600"
check_and_install_artifact "sp8c7a_preflight_runbook.md" 16706 "fcb147c778c7fa569a18274a1414b821345382e8fb734a790bf00cd3b7eb8c49" "600"
check_and_install_artifact "sp8c7a_manifest.json" 6295 "2df5cd9971c7bc79d64d39461b756f46c3d42c4f992bb1b1631039574ff810af" "600"
...
commit_and_cleanup_publication() {
    ...
    reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh" 66422 "9ee266b4c2b62da63a08505efd0389ce54253e9b39c6659f316a47b6a564ba98" "1001:1001" "700"
    reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh.sha256" 86 "5c0090543217c89cbac6efd48fe60df18114c20adb128c2427ec21c18a22c252" "1001:1001" "600"
    reverify_destination_file "${DEST_DIR}/sp8c7a_preflight_runbook.md" 16706 "fcb147c778c7fa569a18274a1414b821345382e8fb734a790bf00cd3b7eb8c49" "1001:1001" "600"
    reverify_destination_file "${DEST_DIR}/sp8c7a_manifest.json" 6295 "2df5cd9971c7bc79d64d39461b756f46c3d42c4f992bb1b1631039574ff810af" "1001:1001" "600"
...
set +e
EXPECTED_SP8C7A_SHA256="9ee266b4c2b62da63a08505efd0389ce54253e9b39c6659f316a47b6a564ba98" \
EXPECTED_SP8C7A_BYTES="66422" \
