...
# GATE SP-8C-7A: REVISION R14 HOST SYNCHRONIZATION & PREFLIGHT EXECUTION WRAPPER
...
echo "========================================================================"
echo ">>> HIGIENE (PTY) LTD — GATE SP-8C-7A REVISION R14 HOST WRAPPER"
...
if [ "$(id -u)" -ne 0 ]; then
    echo "CRITICAL ERROR: run_sp8c7a_r14.sh must be executed as root (EUID 0)!" >&2
    exit 1
fi
...
# Hardcoded trust anchor for sp8c7a_preflight.sh (Revision R14)
EXPECTED_SCRIPT_SHA256="356b0d5ff70c7b530f0107059125eaddf1e733b04183b708aa9bb0429dd9bcbf"
EXPECTED_SCRIPT_BYTES=51560
EXPECTED_SCRIPT_LINES=1249

# Hardcoded trust anchor for sp8c7a_preflight.sh.sha256 (Revision R14)
EXPECTED_SIDECAR_SHA256="1ce89ffc6ff748652ba383fe7e873e3256960a3204b700b81f0e400b5b7df4a4"
EXPECTED_SIDECAR_BYTES=86
EXPECTED_SIDECAR_LINES=1

# Hardcoded trust anchor for sp8c7a_preflight_runbook.md (Revision R14)
EXPECTED_RUNBOOK_SHA256="c248dca9babc49f5551f0ec672d561df2ffc66da1e5ebd43ec35d1cabb19cd94"
EXPECTED_RUNBOOK_BYTES=7376
EXPECTED_RUNBOOK_LINES=76

# Hardcoded trust anchor for sp8c7a_manifest.json (Revision R14)
EXPECTED_MANIFEST_SHA256="e7205d40116d860fabb68b1a8dd36004b115fac077bc8f2f6deca8208c5af79f"
EXPECTED_MANIFEST_BYTES=3391
EXPECTED_MANIFEST_LINES=80
...
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh" 51560 "356b0d5ff70c7b530f0107059125eaddf1e733b04183b708aa9bb0429dd9bcbf"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh.sha256" 86 "1ce89ffc6ff748652ba383fe7e873e3256960a3204b700b81f0e400b5b7df4a4"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight_runbook.md" 7376 "c248dca9babc49f5551f0ec672d561df2ffc66da1e5ebd43ec35d1cabb19cd94"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_manifest.json" 3391 "e7205d40116d860fabb68b1a8dd36004b115fac077bc8f2f6deca8208c5af79f"
...
assert rev == "R14", f"revision expected R14, got {rev}"
...
expected_workload_members = {
    "sp8c7a_preflight.sh": {
        "bytes": 51560,
        "lines": 1249,
        "sha256": "356b0d5ff70c7b530f0107059125eaddf1e733b04183b708aa9bb0429dd9bcbf",
        "role": "unified_self_contained_strictly_read_only_host_preflight_script"
    },
    "sp8c7a_preflight.sh.sha256": {
        "bytes": 86,
        "lines": 1,
        "sha256": "1ce89ffc6ff748652ba383fe7e873e3256960a3204b700b81f0e400b5b7df4a4",
        "role": "corroborating_script_checksum_sidecar"
    },
    "sp8c7a_preflight_runbook.md": {
        "bytes": 7376,
        "lines": 76,
        "sha256": "c248dca9babc49f5551f0ec672d561df2ffc66da1e5ebd43ec35d1cabb19cd94",
        "role": "operational_preflight_runbook_and_invariants_revision_r14"
    }
}
...
echo "Staged manifest verified: schema 1.0, gate SP-8C-7A, revision R14, exactly 3 payload members with exact field values."
...
check_and_install_artifact "sp8c7a_preflight.sh" 51560 "356b0d5ff70c7b530f0107059125eaddf1e733b04183b708aa9bb0429dd9bcbf" "700"
check_and_install_artifact "sp8c7a_preflight.sh.sha256" 86 "1ce89ffc6ff748652ba383fe7e873e3256960a3204b700b81f0e400b5b7df4a4" "600"
check_and_install_artifact "sp8c7a_preflight_runbook.md" 7376 "c248dca9babc49f5551f0ec672d561df2ffc66da1e5ebd43ec35d1cabb19cd94" "600"
check_and_install_artifact "sp8c7a_manifest.json" 3391 "e7205d40116d860fabb68b1a8dd36004b115fac077bc8f2f6deca8208c5af79f" "600"
...
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh" 51560 "356b0d5ff70c7b530f0107059125eaddf1e733b04183b708aa9bb0429dd9bcbf" "1001:1001" "700"
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh.sha256" 86 "1ce89ffc6ff748652ba383fe7e873e3256960a3204b700b81f0e400b5b7df4a4" "1001:1001" "600"
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight_runbook.md" 7376 "c248dca9babc49f5551f0ec672d561df2ffc66da1e5ebd43ec35d1cabb19cd94" "1001:1001" "600"
reverify_destination_file "${DEST_DIR}/sp8c7a_manifest.json" 3391 "e7205d40116d860fabb68b1a8dd36004b115fac077bc8f2f6deca8208c5af79f" "1001:1001" "600"
...
set +e
EXPECTED_SP8C7A_SHA256="356b0d5ff70c7b530f0107059125eaddf1e733b04183b708aa9bb0429dd9bcbf" \
EXPECTED_SP8C7A_BYTES="51560" \
...
echo "========================================================================"
echo "Gate SP-8C-7A Revision R14 host synchronization and preflight execution PASSED with exit code 0."
exit 0
