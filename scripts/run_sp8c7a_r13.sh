...
# GATE SP-8C-7A: REVISION R13 HOST SYNCHRONIZATION & PREFLIGHT EXECUTION WRAPPER
...
echo "========================================================================"
echo ">>> HIGIENE (PTY) LTD — GATE SP-8C-7A REVISION R13 HOST WRAPPER"
...
if [ "$(id -u)" -ne 0 ]; then
    echo "CRITICAL ERROR: run_sp8c7a_r13.sh must be executed as root (EUID 0)!" >&2
    exit 1
fi
...
# Hardcoded trust anchor for sp8c7a_preflight.sh (Revision R13)
EXPECTED_SCRIPT_SHA256="d7e23d19d049a5f17019b43ef99519cf834d0eb6907ccc3d0647069daab0f466"
EXPECTED_SCRIPT_BYTES=51542
EXPECTED_SCRIPT_LINES=1255

# Hardcoded trust anchor for sp8c7a_preflight.sh.sha256 (Revision R13)
EXPECTED_SIDECAR_SHA256="0180fa5f53c34edcbb43040d792fda005e9311417ea9c9764c186e9056a2f4c1"
EXPECTED_SIDECAR_BYTES=86
EXPECTED_SIDECAR_LINES=1

# Hardcoded trust anchor for sp8c7a_preflight_runbook.md (Revision R13)
EXPECTED_RUNBOOK_SHA256="005a51def9dbdb6ee462c2f5c2ca968873efc2d312c41254e44089e29020329a"
EXPECTED_RUNBOOK_BYTES=5946
EXPECTED_RUNBOOK_LINES=57

# Hardcoded trust anchor for sp8c7a_manifest.json (Revision R13)
EXPECTED_MANIFEST_SHA256="75bc0424e602e01ea2adf21fd06752b25aca6a5a6043e95703f57780998708e6"
EXPECTED_MANIFEST_BYTES=3129
EXPECTED_MANIFEST_LINES=76
...
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh" 51542 "d7e23d19d049a5f17019b43ef99519cf834d0eb6907ccc3d0647069daab0f466"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh.sha256" 86 "0180fa5f53c34edcbb43040d792fda005e9311417ea9c9764c186e9056a2f4c1"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight_runbook.md" 5946 "005a51def9dbdb6ee462c2f5c2ca968873efc2d312c41254e44089e29020329a"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_manifest.json" 3129 "75bc0424e602e01ea2adf21fd06752b25aca6a5a6043e95703f57780998708e6"
...
assert rev == "R13", f"revision expected R13, got {rev}"
...
expected_workload_members = {
    "sp8c7a_preflight.sh": {
        "bytes": 51542,
        "lines": 1255,
        "sha256": "d7e23d19d049a5f17019b43ef99519cf834d0eb6907ccc3d0647069daab0f466",
        "role": "unified_self_contained_strictly_read_only_host_preflight_script"
    },
    "sp8c7a_preflight.sh.sha256": {
        "bytes": 86,
        "lines": 1,
        "sha256": "0180fa5f53c34edcbb43040d792fda005e9311417ea9c9764c186e9056a2f4c1",
        "role": "corroborating_script_checksum_sidecar"
    },
    "sp8c7a_preflight_runbook.md": {
        "bytes": 5946,
        "lines": 57,
        "sha256": "005a51def9dbdb6ee462c2f5c2ca968873efc2d312c41254e44089e29020329a",
        "role": "operational_preflight_runbook_and_invariants_revision_r13"
    }
}
...
echo "Staged manifest verified: schema 1.0, gate SP-8C-7A, revision R13, exactly 3 payload members with exact field values."
...
check_and_install_artifact "sp8c7a_preflight.sh" 51542 "d7e23d19d049a5f17019b43ef99519cf834d0eb6907ccc3d0647069daab0f466" "700"
check_and_install_artifact "sp8c7a_preflight.sh.sha256" 86 "0180fa5f53c34edcbb43040d792fda005e9311417ea9c9764c186e9056a2f4c1" "600"
check_and_install_artifact "sp8c7a_preflight_runbook.md" 5946 "005a51def9dbdb6ee462c2f5c2ca968873efc2d312c41254e44089e29020329a" "600"
check_and_install_artifact "sp8c7a_manifest.json" 3129 "75bc0424e602e01ea2adf21fd06752b25aca6a5a6043e95703f57780998708e6" "600"
...
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh" 51542 "d7e23d19d049a5f17019b43ef99519cf834d0eb6907ccc3d0647069daab0f466" "1001:1001" "700"
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh.sha256" 86 "0180fa5f53c34edcbb43040d792fda005e9311417ea9c9764c186e9056a2f4c1" "1001:1001" "600"
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight_runbook.md" 5946 "005a51def9dbdb6ee462c2f5c2ca968873efc2d312c41254e44089e29020329a" "1001:1001" "600"
reverify_destination_file "${DEST_DIR}/sp8c7a_manifest.json" 3129 "75bc0424e602e01ea2adf21fd06752b25aca6a5a6043e95703f57780998708e6" "1001:1001" "600"
...
set +e
EXPECTED_SP8C7A_SHA256="d7e23d19d049a5f17019b43ef99519cf834d0eb6907ccc3d0647069daab0f466" \
EXPECTED_SP8C7A_BYTES="51542" \
...
echo "========================================================================"
echo "Gate SP-8C-7A Revision R13 host synchronization and preflight execution PASSED with exit code 0."
exit 0
