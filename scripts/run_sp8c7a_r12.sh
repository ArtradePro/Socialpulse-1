...
# GATE SP-8C-7A: REVISION R12 HOST SYNCHRONIZATION & PREFLIGHT EXECUTION WRAPPER
...
echo "========================================================================"
echo ">>> HIGIENE (PTY) LTD — GATE SP-8C-7A REVISION R12 HOST WRAPPER"
...
if [ "$(id -u)" -ne 0 ]; then
    echo "CRITICAL ERROR: run_sp8c7a_r12.sh must be executed as root (EUID 0)!" >&2
    exit 1
fi
...
# Hardcoded trust anchor for sp8c7a_preflight.sh (Revision R12)
EXPECTED_SCRIPT_SHA256="97c2705b672ac7250436e5ff6ee8035263c35632c9c4b807a0e88e8580dfc0e7"
EXPECTED_SCRIPT_BYTES=51474
EXPECTED_SCRIPT_LINES=1249

# Hardcoded trust anchor for sp8c7a_preflight.sh.sha256 (Revision R12)
EXPECTED_SIDECAR_SHA256="01b7b9ba73be7bcc745bf9715006d8f7020228ce523378e52e39ea3b8964c6f2"
EXPECTED_SIDECAR_BYTES=86
EXPECTED_SIDECAR_LINES=1

# Hardcoded trust anchor for sp8c7a_preflight_runbook.md (Revision R12)
EXPECTED_RUNBOOK_SHA256="7c2912494dc3d1fd6b6e33bfd46fd1425eabd9f838463b968970292af4b2d507"
EXPECTED_RUNBOOK_BYTES=5003
EXPECTED_RUNBOOK_LINES=43

# Hardcoded trust anchor for sp8c7a_manifest.json (Revision R12)
EXPECTED_MANIFEST_SHA256="f25863318697ac2b3bd758c0cb02ac6621a986281d4214857cc20010f1bb575c"
...
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh" 51474 "97c2705b672ac7250436e5ff6ee8035263c35632c9c4b807a0e88e8580dfc0e7"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh.sha256" 86 "01b7b9ba73be7bcc745bf9715006d8f7020228ce523378e52e39ea3b8964c6f2"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight_runbook.md" 5003 "7c2912494dc3d1fd6b6e33bfd46fd1425eabd9f838463b968970292af4b2d507"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_manifest.json" 2742 "f25863318697ac2b3bd758c0cb02ac6621a986281d4214857cc20010f1bb575c"
...
assert rev == "R12", f"revision expected R12, got {rev}"
...
expected_workload_members = {
    "sp8c7a_preflight.sh": {
        "bytes": 51474,
        "lines": 1249,
        "sha256": "97c2705b672ac7250436e5ff6ee8035263c35632c9c4b807a0e88e8580dfc0e7",
        "role": "unified_self_contained_strictly_read_only_host_preflight_script"
    },
    "sp8c7a_preflight.sh.sha256": {
        "bytes": 86,
        "lines": 1,
        "sha256": "01b7b9ba73be7bcc745bf9715006d8f7020228ce523378e52e39ea3b8964c6f2",
        "role": "corroborating_script_checksum_sidecar"
    },
    "sp8c7a_preflight_runbook.md": {
        "bytes": 5003,
        "lines": 43,
        "sha256": "7c2912494dc3d1fd6b6e33bfd46fd1425eabd9f838463b968970292af4b2d507",
        "role": "operational_preflight_runbook_and_invariants_revision_r12"
    }
}
...
echo "Staged manifest verified: schema 1.0, gate SP-8C-7A, revision R12, exactly 3 payload members with exact field values."
...
check_and_install_artifact "sp8c7a_preflight.sh" 51474 "97c2705b672ac7250436e5ff6ee8035263c35632c9c4b807a0e88e8580dfc0e7" "700"
check_and_install_artifact "sp8c7a_preflight.sh.sha256" 86 "01b7b9ba73be7bcc745bf9715006d8f7020228ce523378e52e39ea3b8964c6f2" "600"
check_and_install_artifact "sp8c7a_preflight_runbook.md" 5003 "7c2912494dc3d1fd6b6e33bfd46fd1425eabd9f838463b968970292af4b2d507" "600"
check_and_install_artifact "sp8c7a_manifest.json" 2742 "f25863318697ac2b3bd758c0cb02ac6621a986281d4214857cc20010f1bb575c" "600"
...
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh" 51474 "97c2705b672ac7250436e5ff6ee8035263c35632c9c4b807a0e88e8580dfc0e7" "1001:1001" "700"
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh.sha256" 86 "01b7b9ba73be7bcc745bf9715006d8f7020228ce523378e52e39ea3b8964c6f2" "1001:1001" "600"
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight_runbook.md" 5003 "7c2912494dc3d1fd6b6e33bfd46fd1425eabd9f838463b968970292af4b2d507" "1001:1001" "600"
reverify_destination_file "${DEST_DIR}/sp8c7a_manifest.json" 2742 "f25863318697ac2b3bd758c0cb02ac6621a986281d4214857cc20010f1bb575c" "1001:1001" "600"
...
set +e
EXPECTED_SP8C7A_SHA256="97c2705b672ac7250436e5ff6ee8035263c35632c9c4b807a0e88e8580dfc0e7" \
EXPECTED_SP8C7A_BYTES="51474" \
...
echo "========================================================================"
echo "Gate SP-8C-7A Revision R12 host synchronization and preflight execution PASSED with exit code 0."
exit 0
