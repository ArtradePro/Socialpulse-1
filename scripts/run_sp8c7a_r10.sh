...
# GATE SP-8C-7A: REVISION R10 HOST SYNCHRONIZATION & PREFLIGHT EXECUTION WRAPPER
...
echo "========================================================================"
echo ">>> HIGIENE (PTY) LTD — GATE SP-8C-7A REVISION R10 HOST WRAPPER"
...
if [ "$(id -u)" -ne 0 ]; then
    echo "CRITICAL ERROR: run_sp8c7a_r10.sh must be executed as root (EUID 0)!" >&2
    exit 1
fi
...
# Hardcoded trust anchor for sp8c7a_preflight.sh (Revision R10)
EXPECTED_SCRIPT_SHA256="ccb0437339ae55221e4ba16a8915af6f448b883459fb4ee7aa62683d14e261d6"
EXPECTED_SCRIPT_BYTES=50258
EXPECTED_SCRIPT_LINES=1220

# Hardcoded trust anchor for sp8c7a_preflight.sh.sha256 (Revision R10)
EXPECTED_SIDECAR_SHA256="113e935575b5816b82c630a48e3a99816c71617f0bff2fc04a0a14e9ce053071"
EXPECTED_SIDECAR_BYTES=86
EXPECTED_SIDECAR_LINES=1

# Hardcoded trust anchor for sp8c7a_preflight_runbook.md (Revision R10)
EXPECTED_RUNBOOK_SHA256="8518202c12b8b047e4e0ad05dfd0501efa3f2409200a77caa0738e160c1a598f"
EXPECTED_RUNBOOK_BYTES=5003
EXPECTED_RUNBOOK_LINES=43

# Hardcoded trust anchor for sp8c7a_manifest.json (Revision R10)
EXPECTED_MANIFEST_SHA256="cc2008ef476337bb3cc0aecc7dad09a5d955cc40a454deaaa33f802d03b92022"
...
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh" 50258 "ccb0437339ae55221e4ba16a8915af6f448b883459fb4ee7aa62683d14e261d6"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight.sh.sha256" 86 "113e935575b5816b82c630a48e3a99816c71617f0bff2fc04a0a14e9ce053071"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_preflight_runbook.md" 5003 "8518202c12b8b047e4e0ad05dfd0501efa3f2409200a77caa0738e160c1a598f"
verify_staged_artifact "${STAGE_DIR}/sp8c7a_manifest.json" 2742 "cc2008ef476337bb3cc0aecc7dad09a5d955cc40a454deaaa33f802d03b92022"
...
assert rev == "R10", f"revision expected R10, got {rev}"
...
expected_workload_members = {
    "sp8c7a_preflight.sh": {
        "bytes": 50258,
        "lines": 1220,
        "sha256": "ccb0437339ae55221e4ba16a8915af6f448b883459fb4ee7aa62683d14e261d6",
        "role": "unified_self_contained_strictly_read_only_host_preflight_script"
    },
    "sp8c7a_preflight.sh.sha256": {
        "bytes": 86,
        "lines": 1,
        "sha256": "113e935575b5816b82c630a48e3a99816c71617f0bff2fc04a0a14e9ce053071",
        "role": "corroborating_script_checksum_sidecar"
    },
    "sp8c7a_preflight_runbook.md": {
        "bytes": 5003,
        "lines": 43,
        "sha256": "8518202c12b8b047e4e0ad05dfd0501efa3f2409200a77caa0738e160c1a598f",
        "role": "operational_preflight_runbook_and_invariants_revision_r10"
    }
}
...
echo "Staged manifest verified: schema 1.0, gate SP-8C-7A, revision R10, exactly 3 payload members with exact field values."
...
check_and_install_artifact "sp8c7a_preflight.sh" 50258 "ccb0437339ae55221e4ba16a8915af6f448b883459fb4ee7aa62683d14e261d6" "700"
check_and_install_artifact "sp8c7a_preflight.sh.sha256" 86 "113e935575b5816b82c630a48e3a99816c71617f0bff2fc04a0a14e9ce053071" "600"
check_and_install_artifact "sp8c7a_preflight_runbook.md" 5003 "8518202c12b8b047e4e0ad05dfd0501efa3f2409200a77caa0738e160c1a598f" "600"
check_and_install_artifact "sp8c7a_manifest.json" 2742 "cc2008ef476337bb3cc0aecc7dad09a5d955cc40a454deaaa33f802d03b92022" "600"
...
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh" 50258 "ccb0437339ae55221e4ba16a8915af6f448b883459fb4ee7aa62683d14e261d6" "1001:1001" "700"
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight.sh.sha256" 86 "113e935575b5816b82c630a48e3a99816c71617f0bff2fc04a0a14e9ce053071" "1001:1001" "600"
reverify_destination_file "${DEST_DIR}/sp8c7a_preflight_runbook.md" 5003 "8518202c12b8b047e4e0ad05dfd0501efa3f2409200a77caa0738e160c1a598f" "1001:1001" "600"
reverify_destination_file "${DEST_DIR}/sp8c7a_manifest.json" 2742 "cc2008ef476337bb3cc0aecc7dad09a5d955cc40a454deaaa33f802d03b92022" "1001:1001" "600"
...
set +e
EXPECTED_SP8C7A_SHA256="ccb0437339ae55221e4ba16a8915af6f448b883459fb4ee7aa62683d14e261d6" \
EXPECTED_SP8C7A_BYTES="50258" \
...
if [ -z "${CANON_LOG}" ]; then
    echo "Warning: Searching /root/ for exact sp8c7a_preflight log..."
...
echo "Gate SP-8C-7A Revision R10 host synchronization and preflight execution PASSED with exit code 0."
exit 0
