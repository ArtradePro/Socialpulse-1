...
export const Workspaces: React.FC = () => {
    ...
    useEffect(() => {
        ...
        setBrandColor(selected.brand_color ?? '#6366f1');
        setBrandLogoUrl(selected.brand_logo_url ?? '');
        setCustomDomain(selected.custom_domain ?? '');
    }, [selected]);
        ...
        <div className="max-w-5xl mx-auto space-y-6">
            <div className="flex items-center justify-between">
                ...
                <button onClick={() => setShowCreate(true)}
                    className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl font-medium hover:opacity-90 transition-opacity text-sm">
                ...
                <div className="col-span-4 space-y-2">
                    {workspaces.length === 0 ? (
                        ...
                        <button key={ws.id} onClick={() => loadDetail(ws)}
                            ...
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center text-white font-bold text-base shrink-0">
                            ...
                            {detailTab === 'branding' ? (
                                <form onSubmit={handleSaveBranding} className="px-6 py-5 space-y-5">
                                    ...
                                    <button type="submit" disabled={savingBrand}
                                        className="w-full py-2.5 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl text-sm font-medium hover:opacity-90 disabled:opacity-50 transition-opacity">
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 space-y-4">
                        ...
                        <form onSubmit={handleCreate} className="space-y-4">
                            ...
                            <button type="submit" disabled={!newName.trim() || creating}
                                className="w-full py-2.5 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl text-sm font-medium">
                                Create
                            </button>
                        </form>
                    </div>
